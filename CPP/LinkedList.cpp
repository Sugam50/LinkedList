/*
Intrduction:A linked list is a basic data structure where each item contains the information that we need to get to the next item.
...
Adding, deleting, inserting, and searching a node 
Stack implementation with linked list 
Finding intersection and union of two lists
